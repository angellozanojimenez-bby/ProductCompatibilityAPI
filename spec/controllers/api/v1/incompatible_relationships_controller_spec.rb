...
describe Api::V1::IncompatibleRelationshipsController do
  ...
  describe "GET #show" do
    ...
    # IncompatibleRelationships' attributes.
    before(:each) do
  ...
  describe "POST #create" do
    ...
    context "when is successfully created" do
      ...
      # attributes in a hash to fulfill the IncompatibleRelationships object.
      before(:each) do
        @product_node_one = FactoryGirl.create :product_nodes
        @product_node_two = FactoryGirl.create :product_nodes
  ...
  describe "PUT/PATCH #update" do
    ...
    context "when is successfully updated" do
      ...
      it "renders the json representation for the updated relationship" do
        relationship_response = json_response
        expect(relationship_response[:incompatible_relationships][:employee_number]).to eql 11991199
      end

...
Productcompatibilityapi::Application.routes.draw do
  ...
  namespace :api, defaults: { format: :json }, constraints: { subdomain: 'api' }, path: '/' do
    ...
    scope module: :v1, constraints: ApiConstraints.new(version: 1, default: true) do
      ...
      get '/compatible_product_relationships/:primary_node_sku', to: 'relationships#show_by_product'
      get '/incompatible_product_relationships/:primary_node_sku', to: 'incompatible_relationships#show_by_product'
